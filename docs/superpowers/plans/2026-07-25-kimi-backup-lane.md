...
```json
{
  ...
  "expectations": [
    ...
    "Every kimi dispatch uses the committed kimi-reviewer-agent.yaml via --agent-file, and resumed calls re-pin --agent-file, -m, --thinking, and -w (a resume missing any of the four is a violation)",
