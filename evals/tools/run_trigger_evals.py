...
provenance header, explicit utf-8 encoding on both open() calls (Windows
defaults to cp1252), and SKILLS_ROOT pointing at this repo's skills/ dir
(upstream keeps skills at the tree root). See LICENSE-THIRD-PARTY.md in
this directory.
